...
const ProductDetailPage = () => {
  ...
  const fetchReviews = async () => {
    // Mock reviews - replace with actual API call later
    setReviews([
      { id: 1, user: 'John Doe', rating: 5, comment: 'Great product! Highly recommend.', date: '2024-01-15' },
      { id: 2, user: 'Jane Smith', rating: 4, comment: 'Good quality, fast shipping.', date: '2024-01-10' },
      { id: 3, user: 'Mike Johnson', rating: 5, comment: 'Exceeded my expectations!', date: '2024-01-05' },
    ]);
  };
  ...
  const handleSubmitReview = () => {
    ...
    console.log('Submit review:', { productId: id, rating, comment });
  ...
  const images = [product.product_image, ...(product.images || [])].filter(Boolean);
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mb-4">
                <div className="flex">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <svg
                      key={star}
                      className={`w-5 h-5 ${
                        star <= (product.rating_average || 0) ? 'text-yellow-400' : 'text-gray-300'
                      }`}
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                ...
                <span className="text-sm font-medium text-gray-700">
                  {product.rating_average || 0} ({product.rating_count || 0} reviews)
                </span>
              </div>
          ...
          <div className="border-t border-gray-200 p-8">
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 mb-8 border border-gray-200">
              ...
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-6 py-3 rounded-lg font-semibold transition shadow-md hover:shadow-lg"
              >
                Submit Review
              </button>
            </div>
