...
const Productlistpage = ({ userId, userRole }) => {
  ...
  return (
    <div className="min-h-screen bg-[#f5f2ed]">
      {/* Header Section */}
      <div className="bg-[#f5f2ed] py-12 px-6">
        <div className="max-w-7xl mx-auto text-center">
          {/* Main Title */}
          <h1 className="text-5xl md:text-6xl font-serif text-[#4a4238] mb-4">
            Our Products
          </h1>
          
          {/* Subtitle */}
          <p className="text-base text-[#8b7d6b] max-w-3xl mx-auto">
      ...
      {/* Search and Sort Bar */}
      <div className="bg-[#f5f2ed] pb-6 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex gap-4">
            ...
            <input
              ...
              className="flex-1 px-6 py-3 bg-white border border-[#d4cdc3] rounded-lg focus:outline-none focus:border-[#8b7355] text-[#4a4238] placeholder-[#a69c8e]"
            />
            ...
            <select
              ...
              className="px-6 py-3 bg-white border border-[#d4cdc3] rounded-lg focus:outline-none focus:border-[#8b7355] text-[#4a4238] cursor-pointer min-w-[200px]"
            >
      ...
      <div className="bg-[#f5f2ed] pb-8 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="bg-[#e8e3db] rounded-lg p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <label className="text-sm font-semibold text-[#4a4238] uppercase tracking-wider">
                    Categories
                  </label>
                </div>
                <select
                  ...
                  className="w-full px-4 py-3 bg-white border border-[#d4cdc3] rounded-lg focus:outline-none focus:border-[#8b7355] text-[#4a4238] cursor-pointer"
                >
      ...
      <div className="max-w-7xl mx-auto px-6 pb-16">
        {loading ? (
          ...
          <div className="bg-white rounded-lg p-16 text-center">
            ...
            <p className="text-[#a69c8e] mt-2">Try adjusting your filters</p>
          </div>
        ) : (
          <>
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
              {products.map((product) => (
                ...
                >
                  ...
                  {/* Product Info */}
                  <div className="p-4">
                    <h3 className="font-semibold text-gray-900 mb-2 text-sm line-clamp-2 min-h-[40px]" title={product.product_name}>
                    ...
                    {currentUserRole === 'buyer' && product.stock_quantity > 0 && (
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-shrink-0 bg-white border-2 border-gray-300 hover:border-blue-500 hover:bg-blue-50 text-gray-700 hover:text-blue-600 p-2.5 rounded-lg transition-all duration-200"
                          title="Add to Cart"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-2.5 px-4 rounded-lg transition-all duration-200 text-sm font-medium"
                        >
                          Buy Now
                        </button>
                      </div>
